export const navItems = [
  ...
  export const projects = [
    ...
    {
      id: 3,
      title: "TikTok API Gateway—Project Orbital",
      des: "Built a Gateway in Golang that accepts HTTP requests with JSON payloads, and employed Kitex's JSON generic call to make JSON generic calls to the respective micro services. Enabled service discovery, load balancing, and dynamic IDL updates.",
      img: "/p3.svg",
      iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/c.svg"],
      link: "https://github.com/yashma-sonara/API_Gateway",
    },
    {
      id: 4,
      title: "GrowthHub—Internship in 2024",
      des: "A event sign-up web app with social media feature. Link to documentation",
      img: "/p4.svg",
